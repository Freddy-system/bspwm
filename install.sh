...
function necesarios(){
  ...
  sudo pacman -S bspwm sxhkd polybar alacritty zsh wget rofi xorg-xrandr picom git unzip zsh lsd bat feh dash xorg-xsetroot zsh-autosuggestions zsh-syntax-highlighting polkit-gnome megatools playerctl qemu-full libvirt iptables openbsd-netcat dmidecode virt-manager timeshift pavucontrol  --noconfirm
...
yay -S brave-bin spotify betterlockscreen --noconfirm

# Personalizar SDDM
bash -x .install/custom.sh
